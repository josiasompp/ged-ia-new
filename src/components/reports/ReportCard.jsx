...
export default function ReportCard({ title, value, subtitle, icon: Icon, growth, color = "blue", isLoading }) {
        ...
        {growth !== undefined && !isLoading && (
          <div className="mt-4 flex items-center gap-2">
            <Badge 
              ...
              className={`text-xs ${isPositiveGrowth ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
            >
              {isPositiveGrowth ? (
